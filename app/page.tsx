...
export default function Home() {
  return (
    <main>
      ...
      <section className="scripture-band"><div><p className="eyebrow">The Great Commission · Matthew 28:19–20</p><blockquote>“Go therefore and make disciples of all nations, baptizing them in the name of the Father and of the Son and of the Holy Spirit, teaching them to observe all that I have commanded you. And behold, I am with you always, to the end of the age.”</blockquote></div><div lang="my"><p className="eyebrow">ယုဒသန်မြန်မာကျမ်း · မဿဲ ၂၈:၁၉–၂၀</p><blockquote>“သင်တို့သွား၍ လူမျိုးတကာတို့ကို ငါ့တပည့် ဖြစ်စေလျက်၊ ခမည်းတော်၊ သားတော်၊ သန့်ရှင်းသော ဝိညာဉ်တော်၏နာမ၌ ဗတ္တိဇံကို ပေးကြလော့။ ငါသည် သင်တို့အား ပေးသမျှသော ပညတ်တော်တို့ကို စောင့်ရှောက်စေခြင်းငှါ ဆုံးမဩဝါဒပေးကြလော့။ ငါသည်လည်း ကပ်ကမ္ဘာကုန်သည်တိုင်အောင် သင်တို့နှင့်အတူ အစဉ်မပြတ် ရှိသည်။”</blockquote></div></section>
